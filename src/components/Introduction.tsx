const Introduction = () => (
	<>
		...
		<div className="text-xl">
			...
			, and we are always looking for special humans and talented engineers to
			join our mission in proving to ourselves "Africans" and to the rest of the
			world that we can build world class technology by Africans in Africa. 🌍
		</div>
	</>
);
