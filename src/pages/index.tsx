  ...
  return (
    <div className="p-5 grid lg:grid-cols-5 sm:grid-cols-2 gap-x-8 gap-y-5">
      ...
      <Block
        ...
        link="blogs"
        className="bg-purple-300 dark:bg-sky-600 col-span-1"
      />
      ...
      <Block
        ...
        description=""
        link="contact"
        className="bg-green-300 dark:bg-green-400 col-span-1"
      />
      ...
      <Block
        ...
        link=""
        className="bg-yellow-300 dark:bg-teal-400 col-span-2"
      />
    </div>
  );
}
