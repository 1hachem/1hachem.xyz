...
export const meta = {
  title: "Learn more",
  slug: "services I provide and their respective pricing",
  topics: ["learn more", "services", "pricing", "contact"],
};
...
<div className="p-5 grid grid-cols-1 md:grid-cols-3  gap-x-8 gap-y-5">
  ...
  <Offer
    ...
    build a user interface for it, deploy it and let you judge the quality of my work !"
    price="3k$ for a prototype"
